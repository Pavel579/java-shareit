...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findByBookerIdAndStartBeforeAndEndAfter(Long userId, LocalDateTime now, LocalDateTime now1, Pageable pageable);

    List<Booking> findByItemOwnerIdAndStartBeforeAndEndAfter(Long userId, LocalDateTime now, LocalDateTime now1, Pageable pageable);
